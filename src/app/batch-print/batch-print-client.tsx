              ...
              >
                ...
                <div style={{
                  ...
                  <div style={{ textAlign: 'right' }}>
                    ...
                    <div style={{ fontWeight: 700, fontFamily: 'monospace', fontSize: '11pt' }}>{b.invoiceNumber}</div>
                    <div style={{ opacity: 0.8, fontSize: '9pt' }}>{formatMonth(b.billingMonth)}</div>
                  </div>
                </div>
                ...
                <div style={{
                  ...
                  <div>
                    <div style={{ fontWeight: 700, fontSize: '11.5pt' }}>{b.tenant?.fullName ?? '—'}</div>
                    {b.tenant?.phone && <div style={{ color: '#64748b', fontSize: '9pt' }}>{b.tenant.phone}</div>}
                  </div>
                  <div style={{ textAlign: 'right' }}>
                    <div style={{ fontWeight: 600, fontSize: '10pt' }}>Room {b.room?.roomNumber ?? '—'}</div>
                    <span style={{
