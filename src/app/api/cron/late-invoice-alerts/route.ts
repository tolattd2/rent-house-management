...
export async function GET(req: NextRequest) {
  ...
  for (const x of newly) {
    ...
    const msg = await buildLateReminderMessage({
      ...
      prevWaterReading: x.b.prevWaterReading,
      currWaterReading: x.b.currWaterReading,
      waterUsage: x.b.waterUsage,
      waterCostRiel: x.b.waterCostRiel,
      prevElectricReading: x.b.prevElectricReading,
      currElectricReading: x.b.currElectricReading,
      electricUsage: x.b.electricUsage,
      electricCostRiel: x.b.electricCostRiel,
      discountUsd: x.b.discountUsd,
      lateDays: x.days,
      penaltyUsd,
